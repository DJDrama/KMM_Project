...
fun LoadingRecipeListShimmer(
    ...
    BoxWithConstraints(modifier = Modifier.fillMaxSize()) {
        ...
        val xCardShimmer = infiniteTransition.animateFloat(initialValue = 0f,
        ...
        val yCardShimmer = infiniteTransition.animateFloat(initialValue = 0f,
        ...
        LazyColumn{
            items(count=5){
                ShimmerRecipeCardItem(colors = colors,
